...
public class JavaFX_LayoutExample extends Application {
    ...
    private void addTextAndImagesToGrid(GridPane grid) {
        ...
        ImageView imageHouse = new ImageView(new Image("org/sla/house.png"));
        ...
        ImageView imageChart = new ImageView(new Image("org/sla/piechart.png"));
    ...
    private void addChartTypeIcons(TilePane tile) {
        for (int i=0; i < 8; i++) {
            tile.getChildren().add(new ImageView(new Image("org/sla/chart_"+(i+1)+".png")));
        }
    }
